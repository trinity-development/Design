...
namespace AutoCAD_test_application
{
    ...
    public class Autocad_test
    {
                ...
                SelectionSet selset = psr.Value;
                   ...
                   // int i = 0;
                    ...
                    foreach (DynamicBlockReferenceProperty prop in props)
                    {
                        ...
                        {
                            Application.ShowAlertDialog("hello2");
                        }
                    }
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                {                                        
                    do
                    {
                        ...
                        blockStatenow = promptRslt.StringResult;                     
                    } while (blockStatenow.Length < 1 );
        ...
        public object[] GetSystemCells(string excelSheet1, string excelSheet2, string excelCells1,  string excelCells2, string excelCells3,string ACcells1, string ACcells2, string ACcells3, string ACcells4, string ACcells5)
        {
            ...
            Excel.Range cells = calcSheet.Range[excelCells1, System.Type.Missing];
            Excel.Range cells1 = calcSheet.Range[excelCells2, System.Type.Missing];
            Excel.Range cells1_1 = calcSheet.Range[excelCells3, System.Type.Missing];
        ...
        /// 
        /// </summary>
        [CommandMethod("UPDATEAPPSNOWNEW")]
